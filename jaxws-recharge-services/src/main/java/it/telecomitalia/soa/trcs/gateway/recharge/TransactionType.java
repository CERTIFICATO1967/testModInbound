...
@XmlSeeAlso({
    it.telecomitalia.soa.trcs.gateway.recharge.OpscBalanceXIbData.Transaction.class,
    it.telecomitalia.soa.trcs.gateway.recharge.ChangeTOCIbData.Transaction.class,
    it.telecomitalia.soa.trcs.gateway.recharge.ReloadXIbData.Transaction.class,
    it.telecomitalia.soa.trcs.gateway.recharge.ChangeNumberIbData.Transaction.class,
    it.telecomitalia.soa.trcs.gateway.recharge.NetworkReconfigureIbData.Transaction.class
})
