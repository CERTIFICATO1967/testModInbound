...
@XmlSeeAlso({
    it.telecomitalia.soa.trcs.gateway.recharge.OpscBalanceXIbData.ClientKeys.class,
    it.telecomitalia.soa.trcs.gateway.recharge.ChangeTOCIbData.ClientKeys.class,
    it.telecomitalia.soa.trcs.gateway.recharge.ReloadXIbData.ClientKeys.class,
    it.telecomitalia.soa.trcs.gateway.recharge.ChangeNumberIbData.ClientKeys.class,
    it.telecomitalia.soa.trcs.gateway.recharge.NetworkReconfigureIbData.ClientKeys.class
})
