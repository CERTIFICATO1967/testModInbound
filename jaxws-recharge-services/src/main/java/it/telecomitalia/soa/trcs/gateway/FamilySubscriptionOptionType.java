 ...
 * 			
 * 
 * <p>Classe Java per FamilySubscriptionOptionType complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="FamilySubscriptionOptionType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "FamilySubscriptionOptionType", propOrder = {
    "activationDate",
    "deactivationDate",
    "expiryDate",
    "offer"
...
@XmlSeeAlso({
    FamilyOfferType.class
})
public class FamilySubscriptionOptionType
    extends OptionalSubscriptionType
{
    ...
    protected List<FamilySubscriptionOptionType.Offer> offer;
     ...
     * {@link FamilySubscriptionOptionType.Offer }
     * 
     * 
     */
    public List<FamilySubscriptionOptionType.Offer> getOffer() {
        if (offer == null) {
            offer = new ArrayList<FamilySubscriptionOptionType.Offer>();
        }
        return this.offer;
    }
