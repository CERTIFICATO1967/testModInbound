...
@XmlSeeAlso({
    it.telecomitalia.soa.trcs.gateway.recharge.GroupedSubscriptionBookingType.Offer.class,
    it.telecomitalia.soa.trcs.gateway.recharge.SubscriptionBookingType.Offer.class,
    it.telecomitalia.soa.trcs.gateway.recharge.FamilySubscriptionOptionType.Offer.class,
    it.telecomitalia.soa.trcs.gateway.recharge.PostpaidSubscriptionOptionType.Offer.class
})
