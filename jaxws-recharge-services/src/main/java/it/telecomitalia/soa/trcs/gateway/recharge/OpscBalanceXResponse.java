...
@XmlRootElement(name = "OpscBalanceXResponse")
public class OpscBalanceXResponse
    extends InfobusXmlMessage
{

    @XmlElement(required = true)
    protected OpscBalanceXResponse.IbData ibData;
     ...
     * @return
     *     possible object is
     *     {@link OpscBalanceXResponse.IbData }
     *     
     */
    public OpscBalanceXResponse.IbData getIbData() {
        return ibData;
    }
     ...
     *     
     */
    public void setIbData(OpscBalanceXResponse.IbData value) {
        this.ibData = value;
    }
