...
@XmlSeeAlso({
    it.telecomitalia.soa.trcs.gateway.recharge.ReloadXRequest.IbData.class,
    it.telecomitalia.soa.trcs.gateway.recharge.ReloadXResponse.IbData.class,
    it.telecomitalia.soa.trcs.gateway.recharge.OpscBalanceXRequest.IbData.class,
    it.telecomitalia.soa.trcs.gateway.recharge.OpscBalanceXResponse.IbData.class
})
