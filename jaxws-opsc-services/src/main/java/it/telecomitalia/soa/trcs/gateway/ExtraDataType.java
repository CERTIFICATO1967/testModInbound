...
@XmlSeeAlso({
    it.telecomitalia.soa.trcs.gateway.GroupedSubscriptionBookingType.Offer.ExtraData.class,
    it.telecomitalia.soa.trcs.gateway.SubscriptionBookingType.Offer.ExtraData.class,
    it.telecomitalia.soa.trcs.gateway.PostpaidSubscriptionOptionType.Offer.ExtraData.class
})
