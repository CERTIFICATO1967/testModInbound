 ...
 *                 &lt;sequence&gt;
 *                   &lt;element name="Request" type="{http://telecomitalia.it/SOA/TRCS/Gateway}ChangeTOCIbData"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/extension&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlRootElement(name = "ChangeTocRequest")
public class ChangeTocRequest
    extends InfobusXmlMessage
{

    @XmlElement(required = true)
    protected ChangeTocRequest.IbData ibData;
     ...
     * @return
     *     possible object is
     *     {@link ChangeTocRequest.IbData }
     *     
     */
    public ChangeTocRequest.IbData getIbData() {
        return ibData;
    }
     ...
     *     
     */
    public void setIbData(ChangeTocRequest.IbData value) {
        this.ibData = value;
    }
        ...
        extends IbDataXmlType
    {
        ...
        protected ChangeTOCIbData request;
         ...
         * @return
         *     possible object is
         *     {@link ChangeTOCIbData }
         *     
         */
        public ChangeTOCIbData getRequest() {
            return request;
        }
         ...
         *     
         */
        public void setRequest(ChangeTOCIbData value) {
            this.request = value;
        }
