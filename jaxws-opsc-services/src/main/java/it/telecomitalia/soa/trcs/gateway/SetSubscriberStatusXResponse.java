...
@XmlRootElement(name = "SetSubscriberStatusXResponse")
public class SetSubscriberStatusXResponse
    extends InfobusXmlMessage
{

    @XmlElement(required = true)
    protected SetSubscriberStatusXResponse.IbData ibData;
     ...
     * @return
     *     possible object is
     *     {@link SetSubscriberStatusXResponse.IbData }
     *     
     */
    public SetSubscriberStatusXResponse.IbData getIbData() {
        return ibData;
    }
     ...
     *     
     */
    public void setIbData(SetSubscriberStatusXResponse.IbData value) {
        this.ibData = value;
    }
