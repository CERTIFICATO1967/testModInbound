...
@XmlRootElement(name = "ChangeNumberResponse")
public class ChangeNumberResponse
    extends InfobusXmlMessage
{

    @XmlElement(required = true)
    protected ChangeNumberResponse.IbData ibData;
     ...
     * @return
     *     possible object is
     *     {@link ChangeNumberResponse.IbData }
     *     
     */
    public ChangeNumberResponse.IbData getIbData() {
        return ibData;
    }
     ...
     *     
     */
    public void setIbData(ChangeNumberResponse.IbData value) {
        this.ibData = value;
    }
