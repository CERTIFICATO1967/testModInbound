...
@XmlRootElement(name = "DeleteSubscriberXResponse")
public class DeleteSubscriberXResponse
    extends InfobusXmlMessage
{

    @XmlElement(required = true)
    protected DeleteSubscriberXResponse.IbData ibData;
     ...
     * @return
     *     possible object is
     *     {@link DeleteSubscriberXResponse.IbData }
     *     
     */
    public DeleteSubscriberXResponse.IbData getIbData() {
        return ibData;
    }
     ...
     *     
     */
    public void setIbData(DeleteSubscriberXResponse.IbData value) {
        this.ibData = value;
    }
