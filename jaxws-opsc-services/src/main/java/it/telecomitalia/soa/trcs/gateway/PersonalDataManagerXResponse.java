...
@XmlRootElement(name = "PersonalDataManagerXResponse")
public class PersonalDataManagerXResponse
    extends InfobusXmlMessage
{

    @XmlElement(required = true)
    protected PersonalDataManagerXResponse.IbData ibData;
     ...
     * @return
     *     possible object is
     *     {@link PersonalDataManagerXResponse.IbData }
     *     
     */
    public PersonalDataManagerXResponse.IbData getIbData() {
        return ibData;
    }
     ...
     *     
     */
    public void setIbData(PersonalDataManagerXResponse.IbData value) {
        this.ibData = value;
    }
