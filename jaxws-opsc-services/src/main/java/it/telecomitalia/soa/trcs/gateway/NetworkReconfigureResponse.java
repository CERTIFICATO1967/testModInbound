...
@XmlRootElement(name = "NetworkReconfigureResponse")
public class NetworkReconfigureResponse
    extends InfobusXmlMessage
{

    @XmlElement(required = true)
    protected NetworkReconfigureResponse.IbData ibData;
     ...
     * @return
     *     possible object is
     *     {@link NetworkReconfigureResponse.IbData }
     *     
     */
    public NetworkReconfigureResponse.IbData getIbData() {
        return ibData;
    }
     ...
     *     
     */
    public void setIbData(NetworkReconfigureResponse.IbData value) {
        this.ibData = value;
    }
