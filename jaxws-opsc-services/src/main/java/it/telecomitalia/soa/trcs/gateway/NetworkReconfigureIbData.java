...
/**
 * <p>Classe Java per NetworkReconfigureIbData complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="NetworkReconfigureIbData"&gt;
 *   &lt;complexContent&gt;
 ...
 *                       &lt;enumeration value="FWARiconf"/&gt;
 *                       &lt;enumeration value="PSD2Riconf"/&gt;
 *                     &lt;/restriction&gt;
 *                   &lt;/simpleType&gt;
 *                 &lt;/attribute&gt;
 *                 &lt;attribute name="Info"&gt;
...
@XmlType(name = "NetworkReconfigureIbData", propOrder = {
    "transaction",
    "clientKeys",
    "operation"
})
public class NetworkReconfigureIbData {

    @XmlElement(name = "Transaction", required = true)
    protected NetworkReconfigureIbData.Transaction transaction;
    @XmlElement(name = "ClientKeys")
    protected NetworkReconfigureIbData.ClientKeys clientKeys;
    @XmlElement(name = "Operation", required = true)
    protected NetworkReconfigureIbData.Operation operation;
     ...
     * @return
     *     possible object is
     *     {@link NetworkReconfigureIbData.Transaction }
     *     
     */
    public NetworkReconfigureIbData.Transaction getTransaction() {
        return transaction;
    }
     ...
     *     
     */
    public void setTransaction(NetworkReconfigureIbData.Transaction value) {
     ...
     * @return
     *     possible object is
     *     {@link NetworkReconfigureIbData.ClientKeys }
     *     
     */
    public NetworkReconfigureIbData.ClientKeys getClientKeys() {
        return clientKeys;
    }
     ...
     *     
     */
    public void setClientKeys(NetworkReconfigureIbData.ClientKeys value) {
     ...
     * @return
     *     possible object is
     *     {@link NetworkReconfigureIbData.Operation }
     *     
     */
    public NetworkReconfigureIbData.Operation getOperation() {
        return operation;
    }
     ...
     *     
     */
    public void setOperation(NetworkReconfigureIbData.Operation value) {
