...
@XmlRootElement(name = "RestoreSubscriberXResponse")
public class RestoreSubscriberXResponse
    extends InfobusXmlMessage
{

    @XmlElement(required = true)
    protected RestoreSubscriberXResponse.IbData ibData;
     ...
     * @return
     *     possible object is
     *     {@link RestoreSubscriberXResponse.IbData }
     *     
     */
    public RestoreSubscriberXResponse.IbData getIbData() {
        return ibData;
    }
     ...
     *     
     */
    public void setIbData(RestoreSubscriberXResponse.IbData value) {
        this.ibData = value;
    }
