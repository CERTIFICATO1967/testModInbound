 ...
 *                 &lt;sequence&gt;
 *                   &lt;element name="Request" type="{http://telecomitalia.it/SOA/TRCS/Gateway}RestoreSubscriberXIbData"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/extension&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlRootElement(name = "RestoreSubscriberXRequest")
public class RestoreSubscriberXRequest
    extends InfobusXmlMessage
{

    @XmlElement(required = true)
    protected RestoreSubscriberXRequest.IbData ibData;
     ...
     * @return
     *     possible object is
     *     {@link RestoreSubscriberXRequest.IbData }
     *     
     */
    public RestoreSubscriberXRequest.IbData getIbData() {
        return ibData;
    }
     ...
     *     
     */
    public void setIbData(RestoreSubscriberXRequest.IbData value) {
        this.ibData = value;
    }
        ...
        extends IbDataXmlType
    {
        ...
        protected RestoreSubscriberXIbData request;
         ...
         * @return
         *     possible object is
         *     {@link RestoreSubscriberXIbData }
         *     
         */
        public RestoreSubscriberXIbData getRequest() {
            return request;
        }
         ...
         *     
         */
        public void setRequest(RestoreSubscriberXIbData value) {
            this.request = value;
        }
