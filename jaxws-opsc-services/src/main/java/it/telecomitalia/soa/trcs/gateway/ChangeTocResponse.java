...
@XmlRootElement(name = "ChangeTocResponse")
public class ChangeTocResponse
    extends InfobusXmlMessage
{

    @XmlElement(required = true)
    protected ChangeTocResponse.IbData ibData;
     ...
     * @return
     *     possible object is
     *     {@link ChangeTocResponse.IbData }
     *     
     */
    public ChangeTocResponse.IbData getIbData() {
        return ibData;
    }
     ...
     *     
     */
    public void setIbData(ChangeTocResponse.IbData value) {
        this.ibData = value;
    }
