...
@XmlRootElement(name = "SaleOperationXResponse")
public class SaleOperationXResponse
    extends InfobusXmlMessage
{

    @XmlElement(required = true)
    protected SaleOperationXResponse.IbData ibData;
     ...
     * @return
     *     possible object is
     *     {@link SaleOperationXResponse.IbData }
     *     
     */
    public SaleOperationXResponse.IbData getIbData() {
        return ibData;
    }
     ...
     *     
     */
    public void setIbData(SaleOperationXResponse.IbData value) {
        this.ibData = value;
    }
