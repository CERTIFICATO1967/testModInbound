...
@XmlRootElement(name = "InstallSubscriberXResponse")
public class InstallSubscriberXResponse
    extends InfobusXmlMessage
{

    @XmlElement(required = true)
    protected InstallSubscriberXResponse.IbData ibData;
     ...
     * @return
     *     possible object is
     *     {@link InstallSubscriberXResponse.IbData }
     *     
     */
    public InstallSubscriberXResponse.IbData getIbData() {
        return ibData;
    }
     ...
     *     
     */
    public void setIbData(InstallSubscriberXResponse.IbData value) {
        this.ibData = value;
    }
