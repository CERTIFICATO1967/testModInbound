...
@XmlRootElement(name = "MigrateSubscriberXResponse")
public class MigrateSubscriberXResponse
    extends InfobusXmlMessage
{

    @XmlElement(required = true)
    protected MigrateSubscriberXResponse.IbData ibData;
     ...
     * @return
     *     possible object is
     *     {@link MigrateSubscriberXResponse.IbData }
     *     
     */
    public MigrateSubscriberXResponse.IbData getIbData() {
        return ibData;
    }
     ...
     *     
     */
    public void setIbData(MigrateSubscriberXResponse.IbData value) {
        this.ibData = value;
    }
